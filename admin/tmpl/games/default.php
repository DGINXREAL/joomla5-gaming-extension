...
/** @var \DGInxreal\Component\Games\Administrator\View\Games\HtmlView $this */

$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn  = $this->escape($this->state->get('list.direction'));
?>

<form action="<?php echo Route::_('index.php?option=com_games&view=games'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table" id="gamesList">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($this->items as $i => $item) : ?>
                                <tr class="row<?php echo $i % 2; ?>">
                                    ...
                                    <td class="text-center">
                                        <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'games.', true); ?>
                                    </td>
                                    <td>
                                        <a href="<?php echo Route::_('index.php?option=com_games&task=game.edit&id=' . $item->id); ?>">
